import 'package:bazarapp/BloC/section3/verficationBLoC/logic.dart';
...
class VerificationCodeEmail extends StatelessWidget {
 ...
 OtpFieldController otpController = OtpFieldController();
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
        create: (context) => VerficationLogic3(),
        child: BlocConsumer<VerficationLogic3, Verficationstate>(
            listener: (context, state) {},
            builder: (context, state) {
              VerficationLogic3 logic = BlocProvider.of(context);
              return Scaffold(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      OTPTextField(
                        ...
                        onCompleted: (pin) {
                          print("Completed: " + pin);
                          // Store OTP value when completed
