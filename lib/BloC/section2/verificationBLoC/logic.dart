...
import 'package:bazarapp/pages/section2/phonenumber.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:flutter/material.dart';

class VerficationLogic extends Cubit<Verficationstate>{

  VerficationLogic() : super(Initstate());
      ...
      if (isVerified) {
        ...
        Navigator.of(context).push(
          MaterialPageRoute(builder: (context) {
            return Phonenumber(); // change after test
          }),
        );
      } else {
        // OTP is invalid
